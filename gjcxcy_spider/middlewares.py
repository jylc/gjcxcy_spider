...
from gjcxcy_spider.settings import PROXIES


class GjcxcySpiderSpiderMiddleware:
...
class GjcxcySpiderDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class RotateUserAgentMiddleware:
    ...
    def process_request(self, request, spider):
        ...
        if ua:
            ...
            # 记录
            # logger.info('Current UserAgent: ' + ua, level='INFO')
